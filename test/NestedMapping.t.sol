...
contract ContractTest is Test {
    ...
    function testUnacquainted() public {
        assertEq(
            uint(myContract.connections(a1, a2)),
            uint(Contract.ConnectionTypes.Unacquainted)
        );
        assertEq(
            uint(myContract.connections(a2, a1)),
            uint(Contract.ConnectionTypes.Unacquainted)
        );
    }
    ...
    function testConnectingBoth() public {
        ...
        assertEq(
            uint(myContract.connections(a1, a2)),
            uint(Contract.ConnectionTypes.Friend)
        );
        assertEq(
            uint(myContract.connections(a2, a1)),
            uint(Contract.ConnectionTypes.Friend)
    ...
    function testConnectingOne() public {
        ...
        assertEq(
            uint(myContract.connections(a1, a2)),
            uint(Contract.ConnectionTypes.Family)
        );
        assertEq(
            uint(myContract.connections(a2, a1)),
            uint(Contract.ConnectionTypes.Unacquainted)
